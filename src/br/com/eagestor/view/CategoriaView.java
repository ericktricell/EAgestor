...
import br.com.eagestor.bean.CategoriaBean;
...
public class CategoriaView extends javax.swing.JDialog {
    ...
    private void salvarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTActionPerformed
        new CategoriaBean().salvar(categoriaField.getText());
        
        this.carregaTabela();
        this.limparBTActionPerformed(evt);
    }//GEN-LAST:event_salvarBTActionPerformed

    private void categoriaFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_categoriaFieldKeyReleased
        String a = categoriaField.getText().toUpperCase();
        categoriaField.setText(a);
    }//GEN-LAST:event_categoriaFieldKeyReleased
    ...
    private void categoriaFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_categoriaFieldKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            getRootPane().setDefaultButton(salvarBT);
        }
    ...
    private void buscaFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscaFieldKeyReleased
        ...
        list = new CategoriaDAO().buscar(txt);
        this.organizaTabela();
