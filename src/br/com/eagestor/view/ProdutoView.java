...
import br.com.eagestor.bean.ProdutosBean;
...
public class ProdutoView extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        marcaField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                marcaFieldKeyReleased(evt);
            }
        });
    ...
    private void catBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_catBTActionPerformed
        ...
        cv.setVisible(true);
        try{
            listCat.add(cv.getCategoria());
            categoriaCB.addItem(cv.getCategoria().getCategoria());
    ...
    private void salvarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTActionPerformed
        if (flag == 0){
            new ProdutosBean().salvar(nomeField.getText(), descricaoField.getText(), listMed.get(medidaCB.getSelectedIndex()),
                    marcaField.getText(), listCat.get(categoriaCB.getSelectedIndex() - 1), inativoCHB.isSelected(), codigoField.getText());
        } else if (flag == 1){
            new ProdutosBean().atualizar(prod.getIdProduto(), nomeField.getText(), descricaoField.getText(), 
                    listMed.get(medidaCB.getSelectedIndex()), marcaField.getText(), 
                    listCat.get(categoriaCB.getSelectedIndex() - 1), inativoCHB.isSelected(), codigoField.getText());
        }
    ...
    private void marcaFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_marcaFieldKeyReleased
        String txt = marcaField.getText().toUpperCase();
        marcaField.setText(txt);
    }//GEN-LAST:event_marcaFieldKeyReleased
    ...
    private void carregaCategoria(){
        listCat = new CategoriaDAO().buscar();
        categoriaCB.addItem("");
    ...
    private void organizaTabela(){
        ...
        for (int i = 0; i < listProd.size(); i++){
            model.addRow(new String[]{
                ...
                listProd.get(i).getIdMedida().getUnidade(),
