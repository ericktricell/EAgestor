...
public class DepartamentoView extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DepartamentoField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DepartamentoFieldKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                DepartamentoFieldKeyReleased(evt);
            }
        });
    ...
    private void DepartamentoFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DepartamentoFieldKeyPressed
        
    }//GEN-LAST:event_DepartamentoFieldKeyPressed

    private void DepartamentoFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DepartamentoFieldKeyReleased
        String a = DepartamentoField.getText().toUpperCase();
        DepartamentoField.setText(a);
    }//GEN-LAST:event_DepartamentoFieldKeyReleased
    ...
    private void buscaFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscaFieldKeyReleased
        listdep = new UsuarioDAO().listaDpt(buscaField.getText());
        this.organizaTabela();
    ...
    private void salvarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTActionPerformed
        switch(flag){
            case 0:
                ...
                new UsuarioDAO().salvaDepartamento(dep);
                this.organizaTabela();
                break;
            case 1:
                dep.setNomeDpto(DepartamentoField.getText());
                new UsuarioDAO().AtualizaDepartamento(dep);
                this.organizaTabela();
                break;
        }
        flag = 0;
    ...
    private void organizaTabela(){
        if (listdep.isEmpty()){
            listdep = new UsuarioDAO().listaDpt();
        }
