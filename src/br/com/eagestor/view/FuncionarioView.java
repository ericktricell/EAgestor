...
import br.com.eagestor.bean.FuncionarioBean;
...
public class FuncionarioView extends javax.swing.JDialog {
    ...
    private void salvarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTActionPerformed
        if (flag == 1){
            ...
            Endereco endereco = new Endereco(logradouroField.getText(), Integer.parseInt(numeroField.getText()), complementoField.getText(), bairroField.getText(), cidadeField.getText(), cepField.getText(), estadoCB.getSelectedItem().toString());
            
            new FuncionarioBean().atualizar(f.getIdFuncionario(), nomeField.getText(), sobreNomeField.getText(), cpfField.getText(),
                    rgField.getText(), nascimentoField.getDate(), admissaoField.getDate(), demissaoField.getDate(),
                    generoCB.getSelectedItem().toString(), cargoField.getText(), codFuncField.getText(),
                    inativoCHB.isSelected(), contato, endereco);
        } else{
            Contato contato = new Contato(comercialField.getText(), celularField.getText(), emailField.getText());
            Endereco endereco = new Endereco(logradouroField.getText(), Integer.parseInt(numeroField.getText()), complementoField.getText(), bairroField.getText(), cidadeField.getText(), cepField.getText(), estadoCB.getSelectedItem().toString());
            
            new FuncionarioBean().salvar(nomeField.getText(), sobreNomeField.getText(), cpfField.getText(),
                    rgField.getText(), nascimentoField.getDate(), admissaoField.getDate(), demissaoField.getDate(),
                    generoCB.getSelectedItem().toString(), cargoField.getText(), codFuncField.getText(),
                    inativoCHB.isSelected(), contato, endereco);
        }
    ...
    private void pesquisaFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pesquisaFieldKeyReleased
        ...
        listf = new FuncionarioDAO().busca(pesquisaField.getText().toUpperCase());
    ...
    private void carregaTabela(){
        listf = new FuncionarioDAO().busca();
        this.organizaTabela();
    }
