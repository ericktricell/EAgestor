...
import br.com.eagestor.bean.PedidosBean;
...
import br.com.eagestor.inativy.relatorioProgress;
...
public class PedidosView extends javax.swing.JDialog {
    ...
    private void salvarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTActionPerformed
        if (flag == 1){
            new PedidosBean().aprova(listpp.get(0).getPedidos().getIdPedido(), aprovadoCheck.isSelected());
            this.dispose();
        } else {
            new PedidosBean().salvaPedido(dataPedidoDC.getDate(), listpp, obsField.getText());
        }
    ...
    private void organizaTabela(){
        ...
        for (int i = 0; i < listpp.size(); i++){
            model.addRow(new String[]{
                ...
                listpp.get(i).getProdutos().getIdMedida().getDescricao(),
            });
        }
    ...
    public List<Pedidos> getPedidosAtualizados(){
        return new PedidosDAO().getPedidos();
    }
