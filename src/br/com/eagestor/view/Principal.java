...
import br.com.eagestor.documentos.FechamentoMes;
import br.com.eagestor.domain.Usuario;
import br.com.eagestor.view.vendas.VendasView;
import br.com.eagestor.inativy.InactivityMonitor;
...
public class Principal extends javax.swing.JFrame {
    ...
    public Principal() {
        ...
        this.setTitle("EAGestor - Estoque, Vendas e Serviços");
        this.iniciaSessao();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        new VendasView(this, true).setVisible(true);
    ...
    private void inatividade(){
        t2 = new Thread(new InactivityMonitor());
	t2.start();
    }
