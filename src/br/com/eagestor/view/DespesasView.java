...
public class DespesasView extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jDateChooser1.setToolTipText("Data do Pagamento");
    ...
    private void salvarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTActionPerformed
        if (flag == 0){
            ...
            new FinanceiroDAO().registraDespesa(dep);
        }
    ...
    private void valorFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_valorFieldFocusLost
        dep.setValor(Double.parseDouble(valorField.getText().replace(",", ".")));
        valorField.setText(new DecimalFormat("¤#,##0.00").format(dep.getValor()));
    }//GEN-LAST:event_valorFieldFocusLost

    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        listDes = new FinanceiroDAO().getDespesa2();
        this.organizaTable();
    }//GEN-LAST:event_jRadioButton1ActionPerformed

    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        listDes = new FinanceiroDAO().getDespesa1();
        this.organizaTable();
    }//GEN-LAST:event_jRadioButton2ActionPerformed

    private void jRadioButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton3ActionPerformed
        listDes = new FinanceiroDAO().getDespesa();
        this.organizaTable();
    ...
    private void organizaTable(){
        ...
        for (Despesas d : listDes){
            ...
            model.addRow(new String[]{
                d.getDescricao(),
                new DecimalFormat("¤#,##0.00").format(d.getValor()),
